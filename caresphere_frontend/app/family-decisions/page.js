  ...
  const handleCastVote =
    async (
      ...
      try {
         ...
         * IMPORTANT:
         *
         * data.decision comes from the Django
         ...
         * so vote confirmation survives refreshes,
         * logouts and future logins.
         */
        updateDecision(
          data.decision
        );
              ...
              <section className="mt-6 space-y-5">
                ...
                {decisions.map(
                  (decision) => {
                     ...
                     *
                     * has_voted comes directly from Django.
                     * It remains true even after refresh,
                     * logout or a new browser session.
                     */
                    const hasVoted =
                      Boolean(
                        decision.has_voted
                    ...
                    const currentVote =
                      decision.current_user_vote ||
                      null;

                    const currentVoteOption =
                      currentVote?.chosen_option ||
                      "";

                    const currentVoteAbstained =
                      Boolean(
                        currentVote
                          ?.is_abstained
                      );
        ...
        decision.voting_deadline
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      {isMyVote && (
                                        ...
                                        <p className="mt-2 text-xs font-black uppercase tracking-[0.1em] text-[#0F766E]">
                                          Your vote
                                        </p>
                                      )}
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <div>
                                ...
                                <p className="mt-1 text-sm leading-6 text-emerald-700">
                                  ...
                                  {currentVoteAbstained
                                    ? "You chose to abstain from this decision."
                                    : currentVoteOption
                                    ? `You voted: ${currentVoteOption}`
                                    : "Your vote is stored securely in CareSphere."}

                                </p>

                                {currentVote?.voted_at && (
                        ...
                        {decision.status ===
                          ...
                          <div className="mt-5 rounded-2xl border border-blue-100 bg-blue-50/60 p-5">
                            ...
                            {/* VOTE FORM ONLY WHEN USER HAS NOT VOTED */}
                            ...
                            {canVote &&
                              ...
                              <div className="mt-5 flex items-center gap-3 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm font-bold text-emerald-700">
                                ...
                                Your vote is already recorded. No further action is required.
