  ...
  useEffect(() => {
    const loadBookings = async () => {
      ...
      try {
        ...
        // ----------------------------------------------
        // Load latest profile so role is authoritative
        // ----------------------------------------------
        ...
        // Backend already filters them by role.
        // ----------------------------------------------
  ...
  const performBookingAction = async (
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          data?.detail ||
            "Unable to update this care request."
        );
      }
      ...
      setError(
        err.message ||
          "We couldn't update this care request."
      );
    } finally {
          ...
          <div className="flex flex-col justify-between gap-8 lg:flex-row lg:items-center">
            ...
            <div>
              ...
              <p className="mt-4 max-w-2xl text-lg leading-8 text-slate-300">
                ...
                {isProvider
                  ? "Review requests from families, accept suitable enquiries and confirm care arrangements."
                  : "Track requests you have sent to care providers and follow their progress from pending to confirmed care."}
            ...
            {filteredBookings.map(
              (booking) => (
                ...
                >
                    ...
                    booking.status ===
                      ...
                      <div className="mt-6 flex flex-wrap gap-3 border-t border-slate-100 pt-5">
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-2 rounded-xl bg-[#0F766E] px-5 py-3 text-sm font-bold text-white transition hover:bg-[#0D655F] disabled:cursor-not-allowed disabled:opacity-60"
                        >
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-2 rounded-xl border border-red-200 bg-red-50 px-5 py-3 text-sm font-bold text-red-700 transition hover:bg-red-100 disabled:cursor-not-allowed disabled:opacity-60"
                        >
                  ...
                  {booking.status ===
                    "confirmed" && (
                    <div className="mt-6 flex items-center gap-2 border-t border-slate-100 pt-5 text-sm font-bold text-emerald-700">
