        ...
        <section className="overflow-hidden rounded-[32px] bg-[#071A2B] px-7 py-10 text-white shadow-xl md:px-10 md:py-12">
          <div className="flex flex-col justify-between gap-8 lg:flex-row lg:items-center">
            ...
            >
              ...
              {isProvider ? "View marketplace" : "Find care"}
            </Link>
          </div>
        </section>
          ...
          {(isProvider
            ? [
                ...
                },
                {
                  ...
                  value: "65%",
                  icon: User,
                  note: "Complete your provider profile",
                },
                {
                  label: "Verification",
            ...
            : [
                {
                  ...
                  value: "0",
                  icon: Star,
                  note: "Start building your shortlist",
                },
                {
                  label: "Upcoming bookings",
                  value: "0",
                ...
                },
                {
                  ...
                  value: "60%",
                  icon: User,
                  note: "Add more details to your profile",
                },
              ]
          ).map((item) => {
        ...
        <section className="mt-8 grid gap-8 lg:grid-cols-[1fr_360px]">
                  ...
                  ? [
                      {
                        ...
                        text: "Add services, pricing, availability and care specialisms.",
                        icon: User,
                      },
                      {
            ...
            <div className="rounded-[28px] border border-slate-200 bg-white p-7 shadow-sm">
              ...
              <div className="mt-7 rounded-2xl bg-slate-50 px-6 py-10 text-center">
                ...
                <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-500">
                  As you use CareSphere, your bookings, saved providers,
                  enquiries and other activity will appear here.
                </p>
              </div>
            </div>
          </div>
          ...
          <aside className="space-y-6">
            <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <h3 className="mt-5 text-xl font-black">{displayName}</h3>
              ...
              <button
                type="button"
                className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl border border-slate-200 py-3 text-sm font-bold text-slate-700 transition hover:bg-slate-50"
              >
